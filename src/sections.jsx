...
const SCHEDULE = {
  d1: {
    ...
    ['09:00 – 09:15', '今日開場', '介紹氫能、能源轉換與海水電解主題', 'highlight'],
    ...
    ['15:50 – 16:00', '總結與明日提醒', '提醒第二天為 AI + 程式語言探索，攜帶學習單並注意集合時間', null]]
  ...
  d2: {
    ...
    ['09:00 – 09:20', '開場與營隊介紹', '說明課程規則與安全事項', 'highlight'],
